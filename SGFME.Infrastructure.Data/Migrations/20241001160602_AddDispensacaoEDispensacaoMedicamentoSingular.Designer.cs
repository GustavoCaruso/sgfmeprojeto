...
namespace SGFME.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241001160602_AddDispensacaoEDispensacaoMedicamentoSingular")]
    partial class AddDispensacaoEDispensacaoMedicamentoSingular
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.Dispensacao", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("fimApac")
                        .HasColumnType("datetime2");

                    b.Property<long>("idCid")
                        .HasColumnType("bigint");

                    b.Property<long>("idPaciente")
                        .HasColumnType("bigint");

                    b.Property<long>("idStatusProcesso")
                        .HasColumnType("bigint");

                    b.Property<long>("idTipoProcesso")
                        .HasColumnType("bigint");

                    b.Property<DateTime>("inicioApac")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("Dispensacao", (string)null);
                });

            modelBuilder.Entity("SGFME.Domain.Entidades.DispensacaoMedicamento", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("idDispensacao")
                        .HasColumnType("bigint");

                    b.Property<long>("idMedicamento")
                        .HasColumnType("bigint");

                    b.Property<bool>("medicamentoChegou")
                        .HasColumnType("bit");

                    b.Property<bool>("medicamentoEntregue")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("recibo")
                        .HasColumnType("bit");

                    b.HasKey("id");

                    b.HasIndex("idDispensacao");

                    b.HasIndex("idMedicamento");

                    b.ToTable("DispensacaoMedicamento", (string)null);
                });
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.PacienteRepresentante", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PacienteRepresentante", (string)null);
                });
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.StatusProcesso", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.TipoProcesso", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.Dispensacao", b =>
                {
                    b.HasOne("SGFME.Domain.Entidades.Cid", "cid")
                        .WithMany()
                        .HasForeignKey("idCid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("SGFME.Domain.Entidades.StatusProcesso", "statusprocesso")
                        .WithMany()
                        .HasForeignKey("idStatusProcesso")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SGFME.Domain.Entidades.TipoProcesso", "tipoprocesso")
                        .WithMany()
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.DispensacaoMedicamento", b =>
                {
                    b.HasOne("SGFME.Domain.Entidades.Dispensacao", null)
                        .WithMany("medicamento")
                        .HasForeignKey("idDispensacao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SGFME.Domain.Entidades.Medicamento", "medicamento")
                        .WithMany()
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.PacienteRepresentante", b =>
                {
                    b.HasOne("SGFME.Domain.Entidades.Paciente", "paciente")
                        .WithMany("pacienterepresentante")
                        .HasForeignKey("idPaciente")
            ...
            modelBuilder.Entity("SGFME.Domain.Entidades.Paciente", b =>
                {
                    ...
                    b.Navigation("pacienterepresentante");
                });
