...
$(document).ready(async function () {
    ...
    $(document).on("click", ".alterar", function (elemento) {
        ...
        window.location.href = "/FuncionarioCadastro?id=" + codigo;
    });
...
function carregarDadosSelecoes() {
    return Promise.all([
        ...
        carregarEstados($("#selectCrfUf")),  // Adiciona o carregamento para CRF - UF
        carregarOpcoes("api/Funcionario/tipoContato", $("#selectTipoContato")),
        carregarOpcoes("api/Funcionario/tipoEndereco", $("#selectTipoEndereco")),
    ]);
}
...
function carregarOpcoesStatus() {
    ...
    return $.ajax({
        url: urlAPI + "api/Funcionario/tipoStatus",
        method: "GET",
...
function carregarOpcoesSexo() {
    ...
    return $.ajax({
        url: urlAPI + "api/Funcionario/tipoSexo",
        method: "GET",
        success: function (data) {
...
function carregarOpcoesEstadoCivil() {
    ...
    return $.ajax({
        url: urlAPI + "api/Funcionario/tipoEstadoCivil",
        method: "GET",
        success: function (data) {
...
function carregarOpcoesCorRaca() {
    ...
    return $.ajax({
        url: urlAPI + "api/Funcionario/tipoCorRaca",
        method: "GET",
        success: function (data) {
...
function carregarOpcoesEstabelecimentoSaude() {
    return $.ajax({
        url: urlAPI + "api/Funcionario/estabelecimentoSaude",
        method: "GET",
        success: function (data) {
            estabelecimentoSaudeOptions = '<option value="0">Selecione um estabelecimento</option>';
            data.forEach(item => {
                estabelecimentoSaudeOptions += `<option value="${item.id}">${item.nomeFantasia}</option>`;
            });
            $("#selectEstabelecimentoSaude").html(estabelecimentoSaudeOptions);
        },
        error: function () {
...
function carregarFuncionarios() {
    ...
    $.ajax({
        url: urlAPI + "api/Funcionario/dadosBasicos",
        method: "GET",
        success: function (data) {
            const tabela = $("#tabela");
            tabela.empty();
...
function mudarStatus(codigo, novoStatus) {
    console.log("Alterando status para Funcionario:", codigo, "Novo Status:", novoStatus);
    $.ajax({
        type: "PATCH",
        url: urlAPI + "api/Funcionario/" + codigo + "/mudarStatus",
        ...
        error: function (xhr, textStatus, errorThrown) {
            ...
            alert("Erro ao alterar o status do funcionário: " + xhr.responseText);
        }
    });
}
...
async function visualizar(codigo) {
    try {
        ...
        const funcionarioPromise = $.ajax({
            type: "GET",
            url: urlAPI + "api/Funcionario/" + codigo + "/dadosCompletos",
            contentType: "application/json;charset=utf-8",
            dataType: "json",
        });
        ...
        const [jsonResult, estados] = await Promise.all([funcionarioPromise, estadosPromise]);
